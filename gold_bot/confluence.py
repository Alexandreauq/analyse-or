...
# (CPI, Emploi US/NFP, décision FOMC) — portage fidèle de la même
# constante côté docs/scalping.js (voir son commentaire pour le
# raisonnement complet et les sources officielles). Ces deux listes
# DOIVENT rester synchronisées — mettre à jour les deux quand le
# calendrier 2027 est publié.
